package com.example.nidhi.covid19tracker
...
import com.pulkit.covidindiatracker.StateListAdapter
        ...
        GlobalScope.launch {
            ...
            if (response.isSuccessful) {
                ...
                launch(Dispatchers.Main) {
                    ...
                    bindStateWiseData(data.statewise?.subList(0, data.statewise.size) as List<StatewiseItem>)
                }
            }
        }
    }
